  ...
  <div id="main">
   ...
   <ul style="margin-top:0;padding-top:5px;margin-left:0;padding-left:20px">
    ...
    <li>
     ...
     Westgate residents). If a weekend evening is still available three days
     in advance (e.g., as of Tuesday, a Friday evening is still open on the
